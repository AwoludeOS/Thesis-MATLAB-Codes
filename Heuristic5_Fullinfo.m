...
% Output: 
% (i) Calculated probability P(n,p,d_i)*P(n,p,d_j)
% (ii) Predicted infected fraction mu
% (iii) Predicted infected fraction \tilde{mu}
% (iv) Estimate for the conditional probability P(Xi=1 | Xj=0)
% (v) Estimate for the conditional probability P(Xj=1 | Xi=0)

function [prob, mu, mus, mucond, muscond] = Heuristic5_Fullinfo(n,p,tau)
